...
export const TEMPLATE_PRESETS: Record<string, Record<string, string[]>> = {
  admin: {
    ...
    settings: ['can_view', 'can_edit', 'can_configure'],
    'qa-report': ['can_view', 'can_create', 'can_edit', 'can_delete', 'can_export', 'can_share', 'can_generate_ai', 'can_use_advanced_ai'],
  ...
  developer: {
    ...
    'writing-assistant': ['can_view', 'can_create', 'can_edit', 'can_generate_ai', 'can_use_advanced_ai'],
    settings: ['can_view'],
