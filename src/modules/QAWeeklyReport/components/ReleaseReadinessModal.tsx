          ...
          <div className="fixed inset-0 z-[101] flex items-center justify-center p-6 pointer-events-none">
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 via-transparent to-amber-500/5 opacity-50" />
                <div className="absolute -top-20 -right-20 w-48 h-48 bg-green-500/15 rounded-full blur-3xl animate-pulse" />
                <div className="absolute -bottom-20 -left-20 w-48 h-48 bg-amber-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start justify-between p-5 pb-3 border-b border-border/30">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={onClose}
                      className="w-8 h-8 rounded-lg bg-surface-elevated hover:bg-hover border border-border/30 flex items-center justify-center text-text-secondary hover:text-text-primary transition-all"
                    >
                      <X className="w-4 h-4" />
                    </motion.button>
                  </div>
                    ...
                    >
                      <div className="relative flex flex-col items-center py-6">
                        ...
                        <div className="relative w-36 h-36">
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <motion.span
                              ...
                              className={`text-4xl font-black ${scoreColors.text}`}
                            >
                              {finalScore}%
                            </motion.span>
                          </div>
                        ...
                        <motion.div
                          ...
                          className={`mt-4 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider border ${
                            finalScore >= 85 ? 'bg-green-500/10 text-green-400 border-green-500/30' :
                    ...
                    >
                      ...
                      <div className="font-mono text-sm space-y-1.5">
                        <div className="flex justify-between text-text-secondary">
                          ...
                          <span className="text-green-400">+{passRateContribution.toFixed(1)}</span>
                        </div>
                        <div className="flex justify-between text-text-secondary">
                          <span>Bugs Factor ({openBugsFactor.toFixed(1)}% × {openBugsWeight}%)</span>
                          <span className="text-amber-400">+{openBugsContribution.toFixed(1)}</span>
                        </div>
                        <div className="border-t border-border/30 pt-2 mt-2 flex justify-between font-bold">
                          <span className="text-text-primary">Final Score</span>
                          <span className={scoreColors.text}>{finalScore}%</span>
                        </div>
                      </div>
                    </motion.div>
